...
(pass? (connected-amp? '(t ((pi+ 1) he+) (pe+ (hi+ 1)))) '(pi+ hi+ hi- pi-))
(pass? (connected-amp? '(t (pe+ he+) (pe+ he+))) nil)

(pass? (funcall (amp-id-fn #'id-of-node)
                '(t ((pi+ 1) (hi+ 1)) ((pi+ 2) (hi+ 2))))
       '(505 510))
(pass? (funcall (amp-id-fn #'id-of-node)
                '(t (pe+ he+) (pe+ he+)))
       '(1000 1000))
(pass? (funcall (ampprod-id-fn #'id-of-node)
                '((t ((pi+ 2) (hi+ 1)) (pe+ (hi+ 2))) (t ((pi+ 1) he+) (pe+ he+))))
       '((509 902) (604 1000)))
(pass? (funcall (ampprod-id-fn #'id-of-node)
                '((t ((pi+ 1) he+) (pe+ he+)) (t (pe+ (hi+ 1)) ((pi+ 2) (hi+ 2)))))
       '((510 901) (604 1000)))
(pass? (funcall (ampprod-id-fn #'id-of-node)
                '((t ((pi+ 2) (hi+ 2)) (pe+ (hi+ 1))) (t ((pi+ 1) he+) (pe+ he+))))
       '((510 901) (604 1000)))
(pass? (funcall (ampprod-id-fn #'id-of-node)
                '((t ((pi+ 1) (hi+ 1)) (pe+ (hi+ 2))) (t ((pi+ 2) he+) (pe+ he+))))
       '((505 902) (608 1000)))
...
(pass? (contract-h2e-ampprod
       ...
       '(((g ((hi- 1) (pi- 1)) ((hi- 2) (pi- 2))) (t ((pi+ 1) (hi+ 1)) (pe+ (hi+ 2)))
          (t ((pi+ 2) he+) (pe+ he+)))
         ((g ((hi- 1) (pi- 1)) ((hi- 2) (pi- 2))) (t ((pi+ 1) (hi+ 1)) ((pi+ 2) he+))
          (t (pe+ (hi+ 2)) (pe+ he+)))
         ((g ((hi- 1) (pi- 1)) ((hi- 2) (pi- 2))) (t ((pi+ 1) (hi+ 1)) (pe+ he+))
          (t ((pi+ 2) (hi+ 2)) (pe+ he+)))
         ((g ((hi- 1) (pi- 1)) ((hi- 2) (pi- 2))) (t ((pi+ 1) (hi+ 1)) (pe+ he+))
          (t (pe+ (hi+ 2)) ((pi+ 2) he+)))
         ((g ((hi- 1) (pi- 1)) ((hi- 2) (pi- 2))) (t (pe+ (hi+ 1)) ((pi+ 1) (hi+ 2)))
          (t ((pi+ 2) he+) (pe+ he+)))
         ((g ((hi- 1) (pi- 1)) ((hi- 2) (pi- 2))) (t ((pi+ 2) (hi+ 1)) ((pi+ 1) he+))
          (t (pe+ (hi+ 2)) (pe+ he+)))
         ((g ((hi- 1) (pi- 1)) ((hi- 2) (pi- 2))) (t (pe+ (hi+ 1)) ((pi+ 1) he+))
          (t (pe+ (hi+ 2)) ((pi+ 2) he+)))
         ((g ((hi- 1) (pi- 1)) ((hi- 2) (pi- 2))) (t (pe+ (hi+ 1)) (pe+ (hi+ 2)))
          (t ((pi+ 1) he+) ((pi+ 2) he+)))
         ((g ((hi- 1) (pi- 1)) ((hi- 2) (pi- 2))) (t ((pi+ 2) (hi+ 1)) (pe+ he+))
          (t ((pi+ 1) (hi+ 2)) (pe+ he+)))
         ((g ((hi- 1) (pi- 1)) ((hi- 2) (pi- 2))) (t (pe+ (hi+ 1)) ((pi+ 2) he+))
          (t ((pi+ 1) (hi+ 2)) (pe+ he+)))
         ((g ((hi- 1) (pi- 1)) ((hi- 2) (pi- 2))) (t (pe+ (hi+ 1)) ((pi+ 2) he+))
          (t ((pi+ 1) he+) (pe+ (hi+ 2))))))
(pass? (mapcar (ampprod-id-fn #'id-of-node)
